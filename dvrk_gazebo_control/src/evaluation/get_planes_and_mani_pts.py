...
if __name__ == "__main__":
    ...
    frame_count = 0
    # plane_count = 0
    saved_plane_path = "/home/baothach/shape_servo_data/generalization/plane/plane_data"
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "home" :   
            ...
            if frame_count == 20:
                rospy.logerr("START getting planes")
                ...
                while k < 100:
                    ...
                    try:
                        ...
                        data = {"plane": constrain_plane, "pc": ordered_current_pc, "pc_goal": ordered_goal_pc}
                        with open(os.path.join(saved_plane_path, f"plane_{k}.pickle"), 'wb') as handle:
