...
if __name__ == "__main__":
    ...
    goal_recording_path = "/home/baothach/shape_servo_data/comparative_study/PPO/training_goals" 
    ...
    while (not close_viewer) and (not all_done): 
                ...
                if action is not None and gym.get_sim_time(sim) - closed_loop_start_time <= 5: 
                    ...
                    if data_point_count == 0:
                        goal_data = {"full pc": full_goal_pc, "partial pc": partial_goal_pc, \
                                    ...
                                    "saved_robot_state": saved_robot_state}
                    else:
                        goal_data = {"full pc": full_goal_pc, "partial pc": partial_goal_pc}
        ...
        if state == "reset":   
            ...
            gym.set_particle_state_tensor(sim, gymtorch.unwrap_tensor(init_object_state))
