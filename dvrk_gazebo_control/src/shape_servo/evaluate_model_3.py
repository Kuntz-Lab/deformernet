...
if __name__ == "__main__":
    ...
    model_2 = PointNetShapeServo2(normal_channel=False)
    model_2.load_state_dict(torch.load("/home/baothach/shape_servo_data/manipulation_points/weights/batch_1-epoch 26"))  
