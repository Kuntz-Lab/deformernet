...
def get_depth_image_and_point_cloud(i):
    ...
    points = np.ones((depth_buffer.shape[0], depth_buffer.shape[1], 3))*-1000
...
if __name__ == "__main__":
    ...
    i = 0
    image_pair_count = 2531
    sample_count = 0
    frame_count = 0
    group_count = 0
    max_group_count = 300
    max_sample_count = 40
    max_data_point_count = 7000
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "home" :   
            ...
            # r = R.from_quat([pc_ros_msg.pose.orientation.x, pc_ros_msg.pose.orientation.y,\
            #                                 pc_ros_msg.pose.orientation.z, pc_ros_msg.pose.orientation.w])
            # print("bounding box pose haha: ", r.as_matrix())
            # # print("bounding box pose haha: ", pc_ros_msg.pose)
