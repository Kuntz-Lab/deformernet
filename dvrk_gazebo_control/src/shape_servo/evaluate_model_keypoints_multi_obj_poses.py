...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("/home/baothach/shape_servo_data/keypoints/combined_w_shape_servo/batch2/weights/run3/batch_2-epoch 100"))  
    model.eval()
...
#    Get goal pc:
    with open('/home/baothach/shape_servo_data/keypoints/combined_w_shape_servo/goal_data_combined/sample 4.pickle', 'rb') as handle:
        ...
        pc_goal = data["ordered partial pcs"][1].reshape(256, 256, 3)     
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "generate preshape":                   
            ...
            if cartesian_goal == None:
                ...
                cartesian_goal.position.x = 0.023#-0.072#-0.081#-0.1134
                cartesian_goal.position.y = -0.252#-0.341#-0.341#-0.33
                cartesian_goal.position.z = 0.032#0.023#0.024#0.0295  
