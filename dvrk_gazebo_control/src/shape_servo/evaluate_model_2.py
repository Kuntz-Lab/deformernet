...
if __name__ == "__main__":
    ...
    # Get goal pc:
    with open('/home/baothach/shape_servo_data/goal_3d(no_cam)', 'rb') as handle:
    ...
    model.load_state_dict(torch.load("/home/baothach/shape_servo_data/weights/PointNet/batch_3"))  
