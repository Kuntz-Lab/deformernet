...
if __name__ == "__main__":
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "get plan":
            ...
            # delta_x = np.random.uniform(low = -0.03, high = 0.03)   
        ...
        if state == "move to goal":
            if frame_count % 10 == 0:
                ...
                pc_on_trajectory.append(deepcopy(get_point_cloud_2(i)))
            ...
            if traj_index == len(plan_traj):
                ...
                pc_goal = deepcopy(get_point_cloud_2(i))
        ...
        #     with open('/home/baothach/shape_servo_data/batch_3b(using_camera)', 'wb') as handle:
    ...
    # data = {"point clouds": final_point_clouds, "positions": final_desired_positions, "saved intial state":saved_object_state}
    # with open('/home/baothach/shape_servo_data/goal_3d(no_cam)', 'wb') as handle:
    #     pickle.dump(data, handle, protocol=pickle.HIGHEST_PROTOCOL)
