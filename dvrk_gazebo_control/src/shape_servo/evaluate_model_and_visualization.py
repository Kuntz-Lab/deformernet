...
if __name__ == "__main__":
    ...
    while (not gym.query_viewer_has_closed(viewer)) and (not all_done):
        ...
        if state == "get desired velocity and deform object":
            ...
            final_velocities.append(main_ins_vel)
            final_main_ins_pos.append(main_ins_pos)
    ...
    visualization_data = {"time": times, "velocity": final_velocities, "position": final_main_ins_pos, "distance": final_distances}
