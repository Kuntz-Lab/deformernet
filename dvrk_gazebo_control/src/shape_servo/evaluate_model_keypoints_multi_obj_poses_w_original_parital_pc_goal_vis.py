...
if __name__ == "__main__":
    ...
    vis_cam_positions.append(gymapi.Vec3(-0.05, -0.15, 0.11)) # sample 3
    # vis_cam_positions.append(gymapi.Vec3(-0.2, -0.2, 0.05))  # sample 2
    # vis_cam_positions.append(gymapi.Vec3(-0.2, -0.47, 0.1)) # sample 0
    ...
    save_path = "/home/baothach/Documents/Deformable object project/paper v2 figures/result_w_goal_points/sample_3/video"
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "generate preshape":                   
            ...
            if cartesian_goal == None:
                ...
                # cartesian_goal.position.x = 0.023#0.023#0.064#-0.077#-0.081#-0.1134
                # cartesian_goal.position.y = -0.252#-0.252#-0.248#-0.331#-0.341#-0.33
                # cartesian_goal.position.z = 0.027#0.032#0.027#0.027#0.024#0.0295  
                
                cartesian_goal.position.x = 0.06956937#0.032465#0.075046243#-0.0676719#-0.04733923#-0.1134
                cartesian_goal.position.y = -0.25008872#-0.26031256#-0.263525#-0.3105266#-0.3336753#-0.33
                cartesian_goal.position.z = 0.032140356#0.032#0.023#0.024#0.0295 
