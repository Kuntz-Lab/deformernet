...
def get_ordered_partial_point_cloud(i):
...
if __name__ == "__main__":
    ...
    # cam_positions.append(gymapi.Vec3(0.05, -0.32, 0.25))  # muti poses
    # cam_targets.append(gymapi.Vec3(0.0, 0.50-two_robot_offset, 0.00))
    cam_positions.append(gymapi.Vec3(0.1, -0.5, 0.2))   # single box
    ...
    # data_recording_path = "/home/baothach/shape_servo_data/keypoints/combined_w_shape_servo/goal_data_combined"
    data_recording_path = "/home/baothach/shape_servo_data/kp_visualization/goal_data"
        ...
        if state == "move to goal":
            ...
            if (not(20 in contacts or 21 in contacts) or not(9 in contacts and 10 in contacts)):  # lose contact w robot 2 or robot 1
                ...
                if traj_index == len(plan_traj):
                    ...
                    # original_partial_pc_goal = get_partial_point_cloud(i)
                    # ordered_partial_pc_goal = get_ordered_partial_point_cloud(i)
                    ...
                    full_pcs = (full_pc_init, full_pc_goal)
                    partial_pcs = (original_partial_pc_init, original_partial_pc_goal)
                    ordered_partial_pcs = (ordered_partial_pc_init, ordered_partial_pc_goal)

                    data = {"full pcs": full_pcs, "partial pcs": partial_pcs, "ordered partial pcs": ordered_partial_pcs, "positions": [delta_x, delta_y, delta_z], "grasp_pose": current_pose["pose"]}
