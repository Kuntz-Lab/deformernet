...
class VecTaskPython(VecTask):
    ...
    def step(self, actions, num_transitions=None, compute_rew_obs=True):       
        # actions_tensor = torch.clamp(actions, -self.clip_actions, self.clip_actions)
        actions_tensor = actions
        if compute_rew_obs:            
            self.task.step(actions_tensor, num_transitions)
            ...
            self.task.step(actions_tensor, num_transitions, False)
