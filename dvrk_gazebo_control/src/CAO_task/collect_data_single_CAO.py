...
def init():
    for i in range(num_envs):
        ...
        davinci_dof_states['pos'][4] = 0.2  #0.24
...
if __name__ == "__main__":
    ...
    object_meshes_path = f"/home/baothach/sim_data/Custom/Custom_mesh/physical_CAO/multi_{object_category}Pa"    
    ...
    asset_root = f"/home/baothach/sim_data/Custom/Custom_urdf/physical_CAO/single/multi_{object_category}Pa"
    ...
    data_recording_path = f"/home/baothach/shape_servo_data/rotation_extension/single_physical_CAO/multi_{object_category}Pa/data"
    mp_data_recording_path = f"/home/baothach/shape_servo_data/manipulation_points/single_physical_CAO/multi_{object_category}Pa/mp_data"
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "home" :   
            ...
            if frame_count == 10:
                ...
                if first_time:                    
                    ...
                    # pc_ros_msg = dc_client.seg_obj_from_file_client(pcd_file_path = "/home/baothach/shape_servo_data/multi_grasps/1.pcd", align_obj_frame = True).obj
        ...
        if state == "generate preshape":                   
            ...
            # FInd points at the top of the object
            current_obj_state = get_object_particle_state(gym, sim)
            top_idxs = np.where(current_obj_state[:,2] > np.max(current_obj_state[:,2]) - 0.01)[0]
            top_points = current_obj_state[top_idxs]
            selected_point = top_points[np.random.choice(top_points.shape[0], 1)[0]]
            target_pose = [-selected_point[0], -selected_point[1], 
                           selected_point[2]-ROBOT_Z_OFFSET, 
                           0, 0.707107, 0.707107, 0]
