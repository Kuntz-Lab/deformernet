...
if __name__ == "__main__":
    ...
    args = gymutil.parse_arguments(
        ...
        custom_parameters=[
            ...
            {"name": "--obj_name", "type": str, "default": '0', "help": "select variations of a primitive shape"},
            {"name": "--headless", "type": bool, "default": False, "help": "headless mode"},
            {"name": "--obj_category", "type": str, "default": "box", "help": "box, cylinder, or hemisphere"},
            {"name": "--data_category", "type": str, "default": "deformernet", "help": "deformernet or MP"}])

    num_envs = args.num_envs
    args.obj_name = f"{args.obj_category}_{args.obj_name}"
    ...
    data_recording_path = "/home/baothach/shape_servo_data/rotation_extension/multi_boxes_1000Pa_2/data"
    terminate_count = 0
    sample_count = 0
    frame_count = 0
    group_count = 0
