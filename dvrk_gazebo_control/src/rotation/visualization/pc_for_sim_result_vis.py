...
if __name__ == "__main__":
    ...
    args = gymutil.parse_arguments(
        ...
        custom_parameters=[
            ...
            {"name": "--obj_name", "type": str, "default": 'box_10', "help": "select variations of a primitive shape"},
    ...
    data_recording_path = "/home/baothach/shape_servo_data/rotation_extension/visualization/TRO_sim_results"
    #### --obj_name box_10
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "get shape servo plan":
            ...
            # delta_x, delta_y, delta_z = -max_x*2/3, max_y/1.3, 0.04 
            delta_x, delta_y, delta_z = -max_x*0.6, max_y*0.6, 0.08
        ...
        if state == "move to goal":
            ...
            if not(9 in contacts or 10 in contacts):  # lose contact w 1 robot
                ...
                if action is not None and gym.get_sim_time(sim) - closed_loop_start_time <= 8: 
                    ...
                    pc_goal_final = get_partial_point_cloud(i)
                    full_pc_goal_final = get_point_cloud()
    
                    partial_pcs = (pc_init, pc_goal_final)
                    full_pcs = (full_pc_init, full_pc_goal_final)
                    ...
                    with open(os.path.join(data_recording_path, "single arm sample " + str(data_point_count) + ".pickle"), 'wb') as handle:
