...
if __name__ == "__main__":
    ...
    # vis_cam_positions.append(gymapi.Vec3(0.0, -0.6, 0.1))
    # vis_cam_positions.append(gymapi.Vec3(-0.15, -0.35, 0.1))
    # vis_cam_positions.append(gymapi.Vec3(-0.001, -0.42, 0.25))
    # vis_cam_positions.append(gymapi.Vec3(-0.00, -0.6, 0.1))
    
    
    ### Single Box
    #Max
    # vis_cam_positions.append(gymapi.Vec3(-0.05, -0.57, 0.05))   # Node dist
    # vis_cam_targets.append(gymapi.Vec3(0.0, -0.42, 0.01))
    # vis_cam_positions.append(gymapi.Vec3(0.15, -0.6, 0.05))   # Chamfer dist
    # vis_cam_targets.append(gymapi.Vec3(0.0, -0.42, 0.01))
        
    # #75th
    # vis_cam_positions.append(gymapi.Vec3(-0.05, -0.64, 0.05))   # Node dist
    # vis_cam_targets.append(gymapi.Vec3(0.0, -0.42, 0.01))    
    # vis_cam_positions.append(gymapi.Vec3(0.05, -0.57, 0.05))   # Chamfer dist
    # vis_cam_targets.append(gymapi.Vec3(0.0, -0.42, 0.01))

    # #Median
    # vis_cam_positions.append(gymapi.Vec3(-0.12, -0.47, 0.05))   # Node dist
    # vis_cam_targets.append(gymapi.Vec3(0.0, -0.42, 0.01)) 
    vis_cam_positions.append(gymapi.Vec3(0.05, -0.57, 0.05))   # Chamfer dist
    vis_cam_targets.append(gymapi.Vec3(0.0, -0.42, 0.01)) 

    # #25th
    # vis_cam_positions.append(gymapi.Vec3(0.02, -0.55, 0.05))   # Node dist
    # vis_cam_targets.append(gymapi.Vec3(0.0, -0.42, 0.01)) 
    # vis_cam_positions.append(gymapi.Vec3(0.05, -0.57, 0.05))   # Chamfer dist
    # vis_cam_targets.append(gymapi.Vec3(0.0, -0.42, 0.01)) 

    # #Min
    # vis_cam_positions.append(gymapi.Vec3(0.00, -0.57, 0.05))   # Node dist
    # vis_cam_targets.append(gymapi.Vec3(0.0, -0.42, 0.01)) 
    # vis_cam_positions.append(gymapi.Vec3(0.05, -0.57, 0.05))   # Chamfer dist
    # vis_cam_targets.append(gymapi.Vec3(0.0, -0.42, 0.01)) 
    ...
    ## Cylinder
        ...
        deformernet_epoch_num_dict = {0:200, 1:160, 2:100, 3:220}
    ...
    vis_frame_count = 0
    num_image = 0
    image_path = "/home/baothach/shape_servo_data/rotation_extension/visualization/TRO_sim_results"
    save_path = os.path.join(image_path, "recordings", "test_1")  
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if prepare_vis_cam:
            ...
            color = (0, 0, 255)
            thickness = 2 
            goal_xs, goal_ys = get_goal_projected_on_image(down_sampling(goal_datas[goal_count]["full pcs"][1], num_pts=200), i, thickness = 0)
            ...
            with torch.no_grad():
                ...
                if args.mp_method == "keypoint":
                    if args.prim_name == "cylinder":
                        ...
                        best_mp = get_mp_seg(seg_model=mp_seg_model, pc_init_numpy=init_pc_numpy, pc_initial_tensor=init_pc_tensor, pc_goal_tensor=goal_pc_tensor, \
                                            compute_method="keypoint", num_kp_candidates=100)                
