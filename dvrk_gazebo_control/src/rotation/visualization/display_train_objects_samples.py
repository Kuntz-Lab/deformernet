...
if __name__ == "__main__":
    ...
    asset_root = "/home/baothach/shape_servo_data/rotation_extension/visualization/display_objects/urdf" 


    k = 0
    
    for args.obj_name in ["box", "cylinder", "hemis"]:    #"box", "cylinder", "hemis"
    
        for j in range(2):

            with open(os.path.join(object_meshes_path, f"{args.obj_name}_{j}.pickle"), 'rb') as handle:
            ...
            soft_asset_file = f"{args.obj_name}_{j}.urdf"    
