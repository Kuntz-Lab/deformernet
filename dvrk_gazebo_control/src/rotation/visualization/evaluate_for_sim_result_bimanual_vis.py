...
if __name__ == "__main__":
    ...
    if object_category == "box_1k":
        deformernet_epoch_num = 200#200  
        mp_dense_epoch_num = 160  
          
    elif object_category == "box_5k":
        deformernet_epoch_num = 200  
        mp_dense_epoch_num = 160  
    ...
    # goal_recording_path = "/home/baothach/shape_servo_data/rotation_extension/visualization/TRO_sim_results_bimanual"
    ...
    # with open(os.path.join(goal_recording_path, "bimanual arm sample 0.pickle"), 'rb') as handle:
    ...
    vis_frame_count = 0
    num_image = 0
    image_path = "/home/baothach/shape_servo_data/rotation_extension/visualization/TRO_sim_results_bimanual"
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "generate preshape":                   
            ...
            target_pose_1 = [best_mp_1[0], best_mp_1[1] + two_robot_offset, best_mp_1[2] - ROBOT_Z_OFFSET, 0, 0.707107, 0.707107, 0]  
            target_pose_2 = [-best_mp_2[0], -best_mp_2[1], best_mp_2[2] - ROBOT_Z_OFFSET, 0, 0.707107, 0.707107, 0]  
        ...
        if state == "get shape servo plan":
            ...
            with torch.no_grad():
                ...
                # pos[0] = np.concatenate((goal_pos_1[:,0], goal_pos_2[:,0]))
                # rot_mat_1 = goal_rot_1
                # rot_mat_2 = goal_rot_2
                ...
                # if max(np.abs(pos[0])) > max_delta:
                #     pos[0] *= 1./max(np.abs(pos[0])) * max_delta   
        ...
        if state == "move to goal":           
            ...
            if main_ins_pos_1 <= 0.042 or main_ins_pos_2 <= 0.042 or (not(20 in contacts or 21 in contacts) or not(9 in contacts or 10 in contacts)):  # lose contact w 1 robot
                ...
                if timeit.default_timer() - shapesrv_start_time >= max_shapesrv_time \
                    or plan_count > 5: # get new plan k times
