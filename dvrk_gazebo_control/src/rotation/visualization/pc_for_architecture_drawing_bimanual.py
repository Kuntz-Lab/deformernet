...
if __name__ == "__main__":
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "get shape servo plan":
            ...
            delta_x_1, delta_y_1, delta_z_1 = 0, max_y/3, 0.08 #max_z
            delta_x_2, delta_y_2, delta_z_2 = 0, max_y/3, 0.08 #max_z
            delta_alpha_1, delta_beta_1, delta_gamma_1 = -np.pi/300000, -np.pi/300000, -np.pi/200000
            delta_alpha_2, delta_beta_2, delta_gamma_2 = -np.pi/300000, -np.pi/300000, -np.pi/200000
            ...
            if (not(20 in contacts or 21 in contacts) or not(9 in contacts or 10 in contacts)):  # lose contact w either robot 2 or robot 1    
                ...
                if (action_1 is not None) and (action_2 is not None) and gym.get_sim_time(sim) - closed_loop_start_time <= 8: 
                    ...
                    data = {"full pcs": full_pcs, "partial pcs": partial_pcs, \
                            "mani_point": (mp_mani_point_1["pose"], mp_mani_point_2["pose"]), "obj_name": args.obj_name}
