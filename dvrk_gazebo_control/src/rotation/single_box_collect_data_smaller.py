...
if __name__ == "__main__":
    ...
    data_recording_path = "/home/baothach/shape_servo_data/rotation_extension/box/data_smaller_obj"
    terminate_count = 0
    sample_count = 0
    frame_count = 0
    group_count = 0
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "get shape servo plan":
            ...
            h = 0.2
            max_x = max_y = max_z = 0.055   #h * 0.7 * 0.8 
            # max_z = h / 2.0
            ...
            # delta_x, delta_y, delta_z = 0.1,0.07,0.01
            # delta_alpha, delta_beta, delta_gamma = -np.pi/3,-np.pi/3,-np.pi/2
            # delta_alpha, delta_beta, delta_gamma = 0.001,0.001,0.001
            # delta_alpha, delta_beta, delta_gamma = 1.57,1.57,1.57
