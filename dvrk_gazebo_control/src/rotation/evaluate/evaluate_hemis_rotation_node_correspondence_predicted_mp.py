...
def get_mp_classifier(classifier_model, partial_init_pc, partial_goal_pc, full_init_pc, 
    ...
    # obb = full_pcd.get_oriented_bounding_hemis()
    # center = full_pcd.get_center()    

    # # Get width, height, depth
    # points = np.asarray(obb.get_hemis_points())
...
if __name__ == "__main__":
    ...
    main_path = "/home/baothach/shape_servo_data/rotation_extension/multi_hemis_1000Pa_2/evaluate"
    ...
    args = gymutil.parse_arguments(
        ...
        custom_parameters=[
            ...
            {"name": "--obj_type", "type": str, "default": 'hemis_1k', "help": "hemis1k, hemis5k, etc."},
            ...
            {"name": "--mp_method", "type": str, "default": "dense_predictor", "help": "select MP selection method. \
                        Options: ground_truth, dense_predictor, classifier"},
    ...
    if sim_type is gymapi.SIM_FLEX:
        ...
        sim_params.flex.num_outer_iterations = 10#10#4
    ...
    # object_name = "test_hemis"
    # with open(os.path.join(mesh_dir, f"{object_name}.pickle"), 'rb') as handle:
    #     data = pickle.load(handle)   
    # r = data["radius"]
    # o = data["origin"]
    ...
    # soft_asset_file = "test_hemis.urdf"
    ...
    if args.obj_type == "hemis_1k":
        if no_rot:
            ...
            weight_path = "/home/baothach/shape_servo_data/rotation_extension/multi_hemis_1000Pa_2/weights/run1_no_rot_no_MP"
            model.load_state_dict(torch.load(os.path.join(weight_path, "epoch 214")))             
        else:
            sys.path.append('/home/baothach/shape_servo_DNN/rotation')
            from architecture_2 import DeformerNetMP as DeformerNet
            model = DeformerNet(normal_channel=False).to(device)
            # weight_path = "/home/baothach/shape_servo_data/rotation_extension/multi_hemis_1000Pa_2/weights/run1/"
    ...
    # elif args.obj_type == "hemis_5k":
    #     # weight_path = "/home/baothach/shape_servo_data/generalization/multi_hemis_5kPa/weights/run1"
    #     # model.load_state_dict(torch.load(os.path.join(weight_path, "epoch 250")))  
    #     weight_path = "/home/baothach/shape_servo_data/generalization/multi_hemis_5kPa/weights/run3(partial)"
    #     model.load_state_dict(torch.load(os.path.join(weight_path, "epoch 240")))              
    # elif args.obj_type == "hemis_10k":
    #     weight_path = "/home/baothach/shape_servo_data/generalization/multi_hemis_10kPa/weights/run1"
    ...
    if args.mp_method == "dense_predictor":
        ...
        weight_path = "/home/baothach/shape_servo_data/manipulation_points/multi_hemis_1000Pa_2/weights/seg/run1"
        mp_seg_model.load_state_dict(torch.load(os.path.join(weight_path, "epoch 202")))        

        # weight_path = "/home/baothach/shape_servo_data/manipulation_points/multi_hemis_1000Pa_2/weights/seg/run6"
        ...
        weight_path = "/home/baothach/shape_servo_data/manipulation_points/multi_hemis_1000Pa_2/weights/classifier/run1"
        mp_classifier_model.load_state_dict(torch.load(os.path.join(weight_path, "epoch 98")))    
    ...
    if args.inside:
        ...
        if args.no_rot:
            ...
            chamfer_recording_path = os.path.join(main_path, "chamfer_results", args.obj_type, "inside_classifier_w_rot")
    else:
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "generate preshape":                   
            rospy.loginfo("**Current state: " + state)
            # preshape_response = hemispcopy(preshape_response.palm_goal_pose_world[0].pose)        
            with torch.no_grad():
                ## Ground truth:
            ...
            target_pose = [-best_mp[0], -best_mp[1], best_mp[2] - ROBOT_Z_OFFSET-0.01, 0, 0.707107, 0.707107, 0]  # for heuristic
