...
result_dir = "/home/baothach/shape_servo_data/rotation_extension/multi_cylinders_1000Pa/evaluate/chamfer_results"
# prim_name = "cylinder"
# obj_type = "cylinder_1k"
prim_name = "cylinder"
# obj_type = "cylinder_5k"

object_meshes_path = "/home/baothach/shape_servo_data/evaluation/meshes/cylinder_1k/inside_sample_ratio"
for t in range(1):
    # print("======================================", t)
    # object_name = "cylinder_" + str(t)
    ...
    for obj_type in ['1k']:
        ...
        for method_type in ['gt_']:     
            ...
            if method_type == '':
                ...
                categories += ["long cylinder"]*(len(chamf_w_rot)+len(chamf_no_rot))       
            elif method_type == "normal_":     
                categories += ["random cylinders"]*(len(chamf_w_rot)+len(chamf_no_rot))   
            else:     
                categories += ["random cylinders"]*(len(chamf_w_rot)+len(chamf_no_rot))
...
plt.title('Long cylinders', fontsize=16)
