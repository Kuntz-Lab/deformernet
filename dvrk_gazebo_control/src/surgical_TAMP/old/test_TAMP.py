...
if __name__ == "__main__":
    ...
    object_meshes_path = "/home/baothach/sim_data/Custom/Custom_mesh/multi_cylinder_10kPa"    
    ...
    asset_root = "/home/baothach/sim_data/Custom/Custom_urdf/bimanual_multi_cylinder_10kPa"
    ...
    soft_pose.p = gymapi.Vec3(0, 0.4-two_robot_offset, r/2.0 + 0.001)
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "get shape servo plan":
            ...
            delta_alpha, delta_beta, delta_gamma = np.pi/3, 1e-5, 1e-5    
