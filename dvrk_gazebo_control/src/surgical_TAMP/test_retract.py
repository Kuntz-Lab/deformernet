...
if __name__ == "__main__":
    ...
    if sim_type is gymapi.SIM_FLEX:
        ...
        sim_params.flex.num_outer_iterations = 4#10
    ...
    soft_pose.p = gymapi.Vec3(0.0, -two_robot_offset/2, 0.03)
    ...
    asset_root = "/home/baothach/shape_servo_data/TAMP/object_data/urdf"
    soft_asset_file = 'tissue.urdf'

    rigid_asset_root = "/home/baothach/shape_servo_data/TAMP/object_data/urdf"
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "get shape servo plan":
            ...
            delta_x_1 = -0.1   #np.random.uniform(low = -max_x, high = max_x)
            delta_y_1 = -0.06   #np.random.uniform(low = 0.0, high = max_y)
            ...
            delta_z_2 = 0.00    #np.random.uniform(low = 0.0, high = max_z)   
        ...
        if sample_count == max_sample_count:  
            ...
            saved_object_state = deepcopy(gymtorch.wrap_tensor(gym.acquire_particle_state_tensor(sim))) 
            init_robot_state_1 = deepcopy(gym.get_actor_rigid_body_states(envs[i], kuka_handles[i], gymapi.STATE_ALL))
            data = {"init_robot_state_1": init_robot_state_1, "saved_object_state": saved_object_state}
            write_pickle_data(data, "/home/baothach/shape_servo_data/TAMP/data/saved_states/test.pickle")
