...
if __name__ == "__main__":
    ...
    chamfer_recording_path =  "/home/baothach/shape_servo_data/bimanual/multi_cylinders_1000Pa/evaluate/chamfer_results"
    data_point_count = len(os.listdir(chamfer_recording_path))
    rospy.logerr(f"goal count: {data_point_count}")
    goal_recording_path =  "/home/baothach/shape_servo_data/bimanual/multi_cylinders_1000Pa/evaluate/goals"
    with open(os.path.join(goal_recording_path, "sample " + str(95) + ".pickle"), 'rb') as handle:
    ...
    soft_pose.p = gymapi.Vec3(0.0, -two_robot_offset/2, r/2.0)
    ...
    weight_path = "/home/baothach/shape_servo_data/bimanual/multi_cylinders_1000Pa/weights/run1"
    ...
    # Get goal pc:
    # rospy.logerr(f"goal count: {data_point_count}")
    # goal_recording_path =  "/home/baothach/shape_servo_data/bimanual/cylinder/evaluate/goals"
