...
if __name__ == "__main__":
    ...
    cylinder_shift = np.array([0.05,-0.05,0.05])  #np.array([0.06,-0.02,0.03])
    ...
    goal_pc_numpy = get_cylinder_goal_pc(radius=(0.2*0.7)/(2*np.pi), height=0.15*0.7, translation=[0,-two_robot_offset/2, 0.9*0.04])
