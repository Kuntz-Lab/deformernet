...
if __name__ == "__main__":
    ...
    vis_cam_positions.append(gymapi.Vec3(0.05, -0.37, 0.1)) # sample 3
    ...
    # data_recording_path = "/home/baothach/shape_servo_data/bimanual/box/data"
    terminate_count = 0
    sample_count = 0
    frame_count = 0
    group_count = 0
    ...
    # Get goal pc:
    data_recording_path =  "/home/baothach/shape_servo_data/bimanual/box/goal_data"
    with open(os.path.join(data_recording_path, "sample " + str(4) + ".pickle"), 'rb') as handle:
        data = pickle.load(handle)
    ...
    vis_frame_count = 0
    num_image = 0
    save_path = "/home/baothach/shape_servo_data/bimanual/box/visualization/4"
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "get shape servo plan":
            ...
            tvc_behavior_1 = TaskVelocityControl(desired_position[:3], robot_1, sim_params.dt, 3, vel_limits=vel_limits, error_threshold = 2e-3, second_robot=False)
            tvc_behavior_2 = TaskVelocityControl(desired_position[3:], robot_2, sim_params.dt, 3, vel_limits=vel_limits, error_threshold = 2e-3)
