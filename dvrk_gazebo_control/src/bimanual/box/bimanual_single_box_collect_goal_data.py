...
if __name__ == "__main__":
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "get shape servo plan":
            ...
            delta_x_1, delta_y_1, delta_z_1 = 0.00, max_y/5, 0.11   # or 0.05
            delta_x_2, delta_y_2, delta_z_2 = 0.00, max_y/5, 0.11
            
            # delta_x_1, delta_y_1, delta_z_1 = 0.06, 0%max_y/3.5, 0.02
            # delta_x_2, delta_y_2, delta_z_2 = -0.12, max_y/3, 0.08

            # Sample 3 (0.8,0.75)
            # delta_x_1, delta_y_1, delta_z_1 = 0.07, 0*max_y/6, 0.01
            # delta_x_2, delta_y_2, delta_z_2 = -0.11, 1*max_y/3, 0.07
