...
if __name__ == "__main__":
    ...
    with open(os.path.join(data_recording_path, "sample " + str(0) + ".pickle"), 'rb') as handle:
        data = pickle.load(handle)
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "get shape servo plan":
            ...
            _, nearest_idxs_2 = neigh.kneighbors(np.array(list(init_pose_2["pose"][0]pykdl_utils_server)).reshape(1, -1))
