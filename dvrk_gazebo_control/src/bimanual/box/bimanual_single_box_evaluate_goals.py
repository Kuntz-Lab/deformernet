...
if __name__ == "__main__":
    ...
    chamfer_recording_path =  "/home/baothach/shape_servo_data/bimanual/box/evaluate/chamfer_results"
    terminate_count = 0
    sample_count = 0
    frame_count = 0
    group_count = 0
    ...
    weight_path = "/home/baothach/shape_servo_data/bimanual/box/weights/run1"
    model.load_state_dict(torch.load(os.path.join(weight_path, "epoch 274")))  
    model.eval()
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "home" :   
            ...
            if frame_count == 10:
                ...
                if first_time:                    
                    ...
                    current_pc = get_point_cloud(vis=True)
                    pcd = open3d.geometry.PointCloud()
        ...
        if state == "generate preshape":                   
            ...
            target_pose = [-mani_point_2[0][0], -mani_point_2[0][1], mani_point_2[0][2]-ROBOT_Z_OFFSET,
                            0, 0.707107, 0.707107, 0]
            mtp_behavior_2 = MoveToPose(target_pose, robot_2, sim_params.dt, 1)
                
            target_pose = [mani_point_1[0][0], mani_point_1[0][1] + two_robot_offset, mani_point_1[0][2]-ROBOT_Z_OFFSET,
                            0, 0.707107, 0.707107, 0]
        ...
        if state == "move to goal":
            ...
            if not(9 in contacts or 10 in contacts):  # lose contact w 1 robot
                ...
                if timeit.default_timer() - shapesrv_start_time >= max_shapesrv_time:
                    ...
                    # Terminal conditions
                    if all(abs(desired_position) <= 0.005) or chamfer_dist < min_chamfer_dist:
