...
if __name__ == "__main__":
    ...
    with open(os.path.join(goal_recording_path, "sample " + str(59) + ".pickle"), 'rb') as handle:
    ...
    vis_frame_count = 0
    num_image = 0
    save_path = "/home/baothach/shape_servo_data/bimanual/box/visualization/ISMR"    
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if prepare_vis_cam:
            ...
            color = (0, 0, 255)
            thickness = 2 
            goal_xs, goal_ys = get_goal_projected_on_image(down_sampling(data["full pcs"][1], num_points=512), i, thickness = 0)
        ...
        if state == "get shape servo plan":
            ...
            robot_1_desired_pos = goal_position[:3]
            robot_2_desired_pos = goal_position[3:]
