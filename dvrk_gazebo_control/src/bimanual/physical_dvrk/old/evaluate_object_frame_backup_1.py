...
from utils.point_cloud_utils import down_sampling, world_to_object_frame, object_to_world_frame, transform_point_cloud, compute_world_to_eef, compose_4x4_homo_mat, compute_object_to_eef
...
if __name__ == "__main__":
    ...
    if object_frame:
        ...
        weight_path = f"/home/baothach/shape_servo_data/rotation_extension/bimanual_physical_dvrk/all_objects_object_frame_2/weights/run1_w_rot_w_MP" 
    else:
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "get shape servo plan":
            ...
            print(f"mani_point_1: {mani_point_1}")
            print(f"mani_point_2: {mani_point_2}")
            ...
            if object_frame:
                ...
                eef_pose_1_world_frame = compute_world_to_eef(world_to_object_H, eef_pose_1_object_frame)
                eef_pose_2_world_frame = compute_world_to_eef(world_to_object_H, eef_pose_2_object_frame)             
                ...
                print("goal_pos_1:", goal_pos_1)
                print("\n")
                
                print("predicted_pos_2_world:", eef_pose_2_world_frame[:3,3])
                print("goal_pos_2:", goal_pos_2)
            else:            
