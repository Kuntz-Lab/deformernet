...
if __name__ == "__main__":
    ...
    soft_pose_1.p = gymapi.Vec3(0.17, -0.46, r/2.0)
    ...
    model.load_state_dict(torch.load(os.path.join(weight_path, "epoch 138")))  
    ...
    goal_pc_numpy = flip_pc(get_tube_connect_goal_pc(object_id=2))
    ...
    pcd_goal.paint_uniform_color([1,0.0,0.0])
        ...
        if state == "move to goal":           
            ...
            if not(9 in contacts or 10 in contacts):  # lose contact w 1 robot
                ...
                if timeit.default_timer() - shapesrv_start_time >= max_shapesrv_time:
                    ...
                    # if False:#converge or chamfer_dist < min_chamfer_dist:
