...
if __name__ == "__main__":
    ...
    # eulers = transformations.euler_from_quaternion([0.0, 0.0, 0.707107, 0.707107])
    # print("==============current orientation:", eulers)
    ...
    max_group_count = 15000
    max_sample_count = 1
    max_data_point_count = 6000 #13000
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "home" :   
            ...
            if frame_count == 10:
                ...
                # print("width, height, depth:", pc_ros_msg.width, pc_ros_msg.height, pc_ros_msg.depth)
                # saved_object_state = deepcopy(gymtorch.wrap_tensor(gym.acquire_particle_state_tensor(sim))) 
                ...
                if action is not None and gym.get_sim_time(sim) - closed_loop_start_time <= 8: 
                    ...
                    for j in range(len(pc_on_trajectory)):    
                        ...
                        data = {"full pcs": full_pcs, "partial pcs": partial_pcs, "mani_point": mani_point["pose"], "obj_name": args.obj_name,\
                                ...
                                "init object state": saved_object_state, "init frame state": saved_frame_state}
