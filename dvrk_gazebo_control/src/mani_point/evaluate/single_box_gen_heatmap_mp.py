...
if __name__ == "__main__":
    ...
    result_path = "/home/baothach/shape_servo_data/manipulation_points/box/mp_classifer_data" 
    ...
    max_mp_count = 51 # 1 for ground truth and 10 random MPs
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "home" :   
            ...
            if frame_count == 5:
                ...
                if mp_count == 0:
                    # Get goal pc:
                    with open(os.path.join(data_recording_path, "sample " + str(500) + ".pickle"), 'rb') as handle:
                        data = pickle.load(handle)
