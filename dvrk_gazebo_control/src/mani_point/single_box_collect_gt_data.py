...
if __name__ == "__main__":
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "generate preshape":                   
            ...
            # open3d.io.write_point_cloud("/home/baothach/shape_servo_data/manipulation_points/box/init_box_pc.pcd", pcd) # save_grasp_visual_data , point cloud of the object
            ...
            if not(9 in contacts or 10 in contacts):  # lose contact w 1 robot
                ...
                if traj_index == len(plan_traj):
                    ...
                    for j, cur_pose in enumerate(poses_on_trajectory):
                        ...
                        data = {"full pcs": full_pcs, "partial pcs": partial_pcs, "mani_point": init_pose, "obj_name": args.obj_name,\
