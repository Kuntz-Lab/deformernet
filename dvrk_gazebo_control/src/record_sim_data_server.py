...
class RecordGraspData():
    ...
    def initialize_data_file(self):
        ...
        hand_joint_state_name = ['preshape_1', 'preshape_2', 'proximal_joint_1', 'proximal_joint_2', 'proximal_joint_3']
    ...
    def handle_record_grasp_data(self, req):
        ...
        object_world_seg_pose_list = [req.object_world_seg_pose.position.x, req.object_world_seg_pose.position.y,
               req.object_world_seg_pose.position.z, req.object_world_seg_pose.orientation.x,
               req.object_world_seg_pose.orientation.y, req.object_world_seg_pose.orientation.z, 
               req.object_world_seg_pose.orientation.w]
