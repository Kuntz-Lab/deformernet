...
if __name__ == "__main__":
    ...
    # asset_root = "./"
    asset_root = "./src"
    kuka_asset_file = "/ll4ma_robots_description/urdf/iiwa/static/iiwa_reflex_static_bao.urdf"
    ...
    if not args.headless:
        ...
        cam_target = gymapi.Vec3(0.0, -0.36, 2)
    ...
    close_viewer = False
    robot = Robot(gym, sim, envs[0], kuka_handles_2[0], n_arm_dof=7, robot_name = 'kuka')
