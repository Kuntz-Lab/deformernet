...
if __name__ == "__main__":
    ...
    data_recording_path = "/home/baothach/shape_servo_data/retraction_cutting/eval_data3"
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "move to goal":
            ...
            if not(9 in contacts or 10 in contacts):  # lose contact w 1 robot
                ...
                # if timeit.default_timer() - start_data_collection >= max_data_collection_time:
                #     rospy.logerr("Manipulation takes too long. Resetting ...")
                #     state = "reset" 
