    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "get shape servo plan":
            ...
            if action_count == 0:
                ...
                # # delta_x_1, delta_y_1, delta_z_1 = (rigid_pose.p.x, y_displacement, -0.05)
                # # delta_x_2, delta_y_2, delta_z_2 = (-rigid_pose.p.x, -y_displacement, -0.05)  
                
                # print("old delta_x_1, delta_y_1, delta_z_1:", delta_x_1, delta_y_1, delta_z_1)  
                # print("old delta_x_2, delta_y_2, delta_z_2:", delta_x_2, delta_y_2, delta_z_2)
                
                eef1_to_eef2_y = abs(robot_1.get_ee_cartesian_position()[1] - robot_2.get_ee_cartesian_position()[1])
                # print(f"\n\n*** eef1_to_eef2_y: {eef1_to_eef2_y}\n\n")

                
                delta_x_1 = rigid_pose.p.x + eef1_to_eef2_y/2 * np.sin(obj_angle)
                delta_y_1 = y_displacement + (eef1_to_eef2_y/2 - eef1_to_eef2_y/2 * np.cos(obj_angle))
                delta_z_1 = 0
                delta_x_2 = -rigid_pose.p.x + eef1_to_eef2_y/2 * np.sin(obj_angle)
                delta_y_2 = -y_displacement + (eef1_to_eef2_y/2 - eef1_to_eef2_y/2 * np.cos(obj_angle))
                delta_z_2 = 0
                ...
                # print("\nnew delta_x_1, delta_y_1, delta_z_1:", delta_x_1, delta_y_1, delta_z_1)
                # print("new delta_x_2, delta_y_2, delta_z_2:", delta_x_2, delta_y_2, delta_z_2)
                ...
                delta_x_1, delta_y_1, delta_z_1 = (-rotated_x_dis, rotated_y_dis, -0.12)
                delta_x_2, delta_y_2, delta_z_2 = (-rotated_x_dis, rotated_y_dis, -0.12)
            else:
                all_done = True
            ...
            if action_count == 0: 
                delta_alpha_1, delta_beta_1, delta_gamma_1 = 1e-6, 1*-side_angle, 1e-6
                delta_alpha_2, delta_beta_2, delta_gamma_2 = 1e-6, 1*side_angle, 1e-6
            elif action_count == 1: 
