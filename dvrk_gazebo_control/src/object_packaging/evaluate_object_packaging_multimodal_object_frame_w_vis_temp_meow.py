...
if __name__ == "__main__":
    ...
    if prepare_vis_cam:
        ...
        # vis_cam_position = gymapi.Vec3(rigid_pose.p.x, rigid_pose.p.y - 0.1, 0.3)
        # vis_cam_target = gymapi.Vec3(rigid_pose.p.x, rigid_pose.p.y, 0.01)

        vis_cam_position = gymapi.Vec3(rigid_pose.p.x, rigid_pose.p.y + 0.001, 0.3)   # put camera on top of object
        vis_cam_target = gymapi.Vec3(rigid_pose.p.x, rigid_pose.p.y, 0.01)
