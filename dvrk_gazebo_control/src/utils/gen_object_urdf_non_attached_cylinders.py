...
# save_urdf_path = '/home/baothach/shape_servo_data/evaluation/bimanual_urdf/cylinder_1k/inside'
# object_meshes_path = '/home/baothach/shape_servo_data/evaluation/meshes/cylinder_1k/inside'
# save_urdf_path = "/home/baothach/sim_data/Custom/Custom_urdf/bimanual_multi_cylinder_5kPa"
# object_meshes_path = "/home/baothach/sim_data/Custom/Custom_mesh/multi_cylinder_5kPa" 
save_urdf_path = "/home/baothach/shape_servo_data/evaluation/bimanual_urdf/cylinder_5k/inside"
object_meshes_path = "/home/baothach/shape_servo_data/evaluation/meshes/cylinder_5k/inside"
...
for i in range(0,100):
    ...
    # # with open(os.path.join(object_meshes_path, f"cylinder_{i}.pickle"), 'rb') as handle:
    # #     data = pickle.load(handle)
